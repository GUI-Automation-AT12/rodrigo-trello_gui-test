...
public class Authentication {
    ...
    private static final String BASE_URL_API = EnvironmentProperties.getInstance().getBaseUrl();
    private static final String API_KEY = JsonUser.getInstance().getKey();
    private static final String API_TOKEN = JsonUser.getInstance().getToken();
